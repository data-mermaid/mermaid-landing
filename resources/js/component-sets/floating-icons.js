...
$(function () {
    ...
    if ($(window).width() < 1024) {
        $('.floating-icons').each(function () {
            const tween = new TimelineMax()
                .add([
                    TweenMax.fromTo($(this).find("path:nth-child(1)"), 1, {top: 0}, {y: 60, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(2)"), 1, {top: 0}, {y: 60, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(3)"), 1, {top: 0}, {y: 40, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(4)"), 1, {top: 0}, {y: 40, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(5)"), 1, {top: 0}, {y: 60, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(6)"), 1, {top: 0}, {y: 60, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(7)"), 1, {top: 0}, {y: 80, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(8)"), 1, {top: 0}, {y: 80, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(9)"), 1, {top: 0}, {y: 100, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(10)"), 1, {top: 0}, {y: 100, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(11)"), 1, {top: 0}, {y: 120, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(12)"), 1, {top: 0}, {y: 120, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(13)"), 1, {top: 0}, {y: 140, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find("path:nth-child(14)"), 1, {top: 0}, {y: 140, ease: Linear.easeNone}),
                    TweenMax.fromTo($(this).find(".floating-icons circle"), 1, {top: 0}, {y: 160, ease: Linear.easeNone})
                ]);
